package com.wang.wangpicture.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        System.out.println("动态分表 actual-data-nodes 配置: {}"+newActualDataNodes);
        ...
        if (shardingRule.isPresent()) {
            ...
            System.out.println("动态分表规则更新成功！");
        } else {
            System.out.println("未找到 ShardingSphere 的分片规则配置，动态分表更新失败。");
        }
    }
    ...
    public void createSpacePictureTable(Space space) {
        ...
        if (space.getSpaceType() == SpaceTypeEnum.TEAM.getValue() && space.getSpaceLevel() == SpaceLevelEnum.FLAGSHIP.getValue()) {
            ...
            try {
                ...
                e.printStackTrace();
                System.out.println("创建图片空间分表失败，空间 id = {}"+space.getId());
            }
        }
    }
