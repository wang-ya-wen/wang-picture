package com.wang.wangspace.controller;
...
public class SpaceController {
    ...
    public BaseResponse<Page<SpaceVo>> listSpaceVByPage(@RequestBody SpaceQueryRequest spaceQueryRequest,
                                                            HttpServletRequest request){
        long current = spaceQueryRequest.getCurrent();
        long picSize = spaceQueryRequest.getPageSize();
        //限制爬虫
        ThrowUtils.throwIf(picSize>20,ErrorCode.PARAMS_ERROR);
        //查询数据库
        Page<Space> spacePage=spaceService.page(new Page<>(current,picSize),
